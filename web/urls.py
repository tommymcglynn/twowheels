...
urlpatterns = patterns('',
    ...
    url(r'^gather/(?P<partId>\d+)/(?P<modelId>\d+)/$', views.gather_images, name='gather-images'),
    url(r'^gather/(?P<partId>\d+)/(?P<modelId>\d+)/(?P<styleId>\d+)/$', views.gather_images, name='gather-images'),
    url(r'^gather/(?P<partId>\d+)/(?P<modelId>\d+)/(?P<styleId>\d+)/(?P<start>\d+)/$', views.gather_images, name='gather-images'),
)
